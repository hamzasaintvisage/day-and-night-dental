// Starter blog posts. The owner adds more over time (each new entry here becomes
// a pre-rendered /blog/<slug> page automatically via routes.jsx).
export const posts = [
  {
  ...
  },
  {
    ...
    sections: [
      { heading: 'How they differ', paragraphs: [
        'Invisalign uses a series of clear, removable aligners that are almost invisible and come out for eating and brushing. Fixed braces use brackets and wires bonded to your teeth, which stay put for the whole treatment.',
      ] },
      { heading: 'Which tends to suit who', paragraphs: [
        'Invisalign is popular with adults and older teens who want to straighten up discreetly without anyone noticing. Fixed braces can have the edge for very complex movements. At a consultation we will tell you honestly which is the better fit for your case.',
      ] },
