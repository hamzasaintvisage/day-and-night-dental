...
const data = {
  ...
  seo: { title: "Porcelain Veneers in Glasgow | Day Night Dental", description: "Porcelain veneers in Glasgow to reshape, brighten and even out your smile. Clear advice and a written plan from our Merchant City clinic before anything is agreed." },
  ...
  overview: ["Porcelain veneers are slim ceramic shells, made to fit the front of your teeth. Each one is shaped and shaded for you, then bonded into place. The idea is simple. Cover what bothers you and keep the result looking like teeth, not like a fake smile. People just notice the smile looks tidier.", (<>People come to us for veneers for all sorts of reasons. Teeth that are chipped, worn short, or a colour they can't shift. Small gaps between the front teeth. Teeth that sit slightly uneven and stand out in every photo. Because a veneer changes shape, shade and symmetry together, one plan can tackle all of it, and that's a big part of the appeal. They're not a fix for everything though. Sometimes <Link to="/treatments/composite-bonding/">composite bonding</Link> gets you there with less drilling, and if you're reworking most of the teeth that show, it becomes a <Link to="/treatments/smile-makeover/">smile makeover</Link> conversation instead. We'll go through the options with you at the consultation.</>), "Veneer treatment runs over a few visits, from design to final fit, so it helps that we're easy to reach for every one of them. We're at 80 Hutcheson Street in Merchant City, two or three minutes on foot from Argyle Street and Queen Street stations and the St Enoch subway, which makes the design visit, the fitting and everything in between simple to build around a working day in the centre of Glasgow."],
  facts: [{"dt": "What they are", "dd": "Very thin shells of dental porcelain, bonded to the front of a tooth."}, {"dt": "What they change", "dd": "Shape, shade, size and symmetry. They can close small gaps and hide chips, wear and stubborn discolouration."}, {"dt": "Staining", "dd": "Porcelain has good resistance to staining and holds its colour better than composite bonding."}, {"dt": "Reversibility", "dd": "Getting veneers usually means removing a small amount of enamel first. Because enamel doesn't grow back, this part is not reversible."}, {"dt": "Number of visits", "dd": "Treatment is normally spread over two or three visits across a few weeks, with temporary veneers in between while the lab makes the real ones."}, {"dt": "What you need first", "dd": "Healthy teeth and gums and enough enamel to bond to. Any decay or gum problems are sorted before veneers go on."}, {"dt": "How long they last", "dd": "Well-made porcelain veneers often last around 10 years, and with good care sometimes longer. Your bite, habits and how well you look after them all play a part, so we'll talk through what is realistic for you at the consultation. They are long lasting, not permanent."}],
  ...
  benefits: [
    ...
    { title: 'Preview before committing', body: 'In many cases you can see a mock-up or digital design and react to the proposed look before anything is bonded for good, so there are fewer surprises.' },
  ],
  stepsHeading: (<>Your <em>veneer</em> journey</>),
  steps: [{"title": "Consultation and assessment", "body": (<>We look at your teeth and gums, take photos and X-rays where needed, and talk through what you're unhappy with and what you'd like to change. This is also where we say clearly whether veneers are the right call, or whether something else would suit you better, for example straightening the teeth with <Link to="/treatments/invisalign/">Invisalign</Link> before any veneer is considered.</>)}, {"title": "Smile design and preview", "body": (<>We plan the shape, size and shade with you. If you're thinking about <Link to="/treatments/teeth-whitening/">whitening your teeth</Link>, it's best done before this stage, so the porcelain is matched to your brighter shade. In many cases you can see a preview of the proposed smile, either as a mock-up trialled in your mouth or a digital design, so you can react to it before committing.</>)}, {"title": "Minimal tooth preparation", "body": "A small amount of enamel is gently removed from the front of the teeth so the veneers sit flush and look natural. In some cases little or no enamel needs to come off at all, depending on how your teeth sit. This is usually done with local anaesthetic so you're comfortable. We then take impressions or a scan."}, {"title": "Temporaries", "body": "You go home with temporary veneers to protect the prepared teeth and give you a feel for the new shape while the lab makes your final set."}, {"title": "Final fit", "body": "When the veneers are ready, we try them in, check the fit, colour and bite with you, and bond them into place once you're happy. Small adjustments are normal at this stage."}],
  comparison: {
    eyebrow: 'Compare',
    heading: (<>Porcelain veneers vs <em>composite bonding</em></>),
    intro: "Both can improve the look of front teeth, and composite bonding is often described as composite veneers, so they're easy to mix up. They suit different situations, and it's worth understanding the trade-off before you decide.",
    attribute: 'Feature',
    columns: [
    ...
    rows: [
      ...
      { label: 'Durability', values: ['Often around 10 years with good care', 'Commonly 3 to 5 years, often longer with care'] },
  ...
  aftercare: {
    ...
    phases: [
      { title: 'First day or two', items: ['Your teeth and gums may feel sensitive for the first day or so.', 'You can eat and drink again as soon as any numbness wears off. Softer food and going easy on very hot and very cold things is kinder for the first day.', 'A sensitive toothpaste helps, and mild discomfort settles quickly.'] },
      ...
      { title: 'Day to day, long term', items: ['Treat veneers like natural teeth. Brush twice a day with a soft brush and floss gently around the edges.', 'Look after your gums, not just the veneers.', "Don't bite hard objects like ice, pens or fingernails, and don't use your teeth as tools.", 'If you grind or clench, wear a night guard to protect them.', 'Keep up your check-ups and hygienist visits so we can keep an eye on the margins and gums.', (<>If a veneer ever feels loose or chips, even in the middle of the night, contact our <Link to="/treatments/emergency-dentist/">emergency dentist</Link> service. We are open day and night, every day, so it can be looked at quickly instead of getting worse.</>)] },
    ],
  },
  risks: {
    ...
    body: [
      ...
      "If teeth are quite crooked or rotated, straightening them first often gives a better, healthier result than masking them with veneers. If that's true for you, we'll say so and explain why.",
  ...
  fees: {
    ...
    body: [
      ...
      "Take the plan home, think it over and come back with questions. There is no pressure to decide on the day.",
    ],
  },
  faqHeading: (<>Porcelain veneer questions, <em>answered</em></>),
  faqs: [{"q": "What are porcelain veneers made of?", "a": "They're made from dental porcelain, a hard ceramic that's shaped and shaded to look like natural enamel. Each one is custom made for your tooth, then bonded to the front surface."}, {"q": "Does getting veneers hurt?", "a": "The preparation and fitting are usually done with local anaesthetic, so you shouldn't feel pain at the time. Afterwards some tooth and gum sensitivity for a day or two is normal and settles on its own."}, {"q": "Are veneers reversible?", "a": "No, not once a tooth has been prepared. Because a small amount of enamel is removed and enamel doesn't grow back, the tooth will always need something covering it from then on. It's worth being sure before you start."}, {"q": "How long do porcelain veneers last?", "a": "Well-made porcelain veneers often last around ten years, and with good care sometimes longer. It varies with your bite and your habits. Looking after your gums, avoiding biting hard objects and wearing a night guard if you grind all help them go the distance. We'll give you a realistic picture at your consultation."}, {"q": "Can I see what my smile will look like first?", "a": "Usually, yes. We design the smile with you and in many cases you can preview it, as a mock-up in your mouth or a digital design, before any teeth are prepared. It means fewer surprises at the end."}, {"q": "Can porcelain veneers be done in one visit?", "a": "Ours can't, and that's deliberate. Your veneers are made in a dental laboratory, where a technician builds the porcelain up in layers to get the shade and translucency right, and that work takes time. You wear temporary veneers in between, so you're never left with unfinished teeth. If you want a front tooth improved in a single visit, composite bonding is usually the way to do it."}, {"q": "What about composite veneers or no-prep veneers?", "a": "Composite veneers are the same treatment we call composite bonding: tooth-coloured resin shaped directly onto the tooth, often with little or no drilling, and usually finished in one appointment. Minimal-preparation or no-prep porcelain veneers are sometimes possible too, depending on the size and position of your teeth. Neither suits every case, so we assess which routes are open to you before anything starts."}, {"q": "How many veneers will I need?", "a": "It depends on how many teeth show when you smile and what you want to change. Some people only need a couple, others want the whole smile line done so the colour and shape match across the front. We'll work this out with you at the consultation."}, {"q": "How much do porcelain veneers cost?", "a": "Every mouth is different, so the honest answer is that it depends on you: how many teeth you are treating, whether any groundwork such as gum care or straightening is needed first, and the level of design detail involved. At your consultation the dentist will go through your options and the cost of each, and you will get a written, itemised quote before anything is agreed. Nothing goes ahead until you are happy."}, {"q": "Can I get veneers on the NHS?", "a": "Not normally. Purely cosmetic treatment, which includes veneers along with bonding, whitening and smile makeovers, is private-only. NHS dental examinations are free for everyone in Scotland. NHS dental treatment is free if you are under 26, pregnant or have given birth in the last 12 months, or qualify for a low-income exemption. That cover is for clinical need, though, rather than cosmetic work like veneers."}, {"q": "Will my veneers stain like normal teeth?", "a": "Porcelain tends to resist staining, so it holds its colour well. The bonding edges and your own teeth can still pick up stains over time, so coffee, tea, red wine and smoking still take a toll. Regular cleaning keeps things looking even. One more thing: porcelain can't be whitened once it's made, so if you want whiter teeth, whiten first and we'll match the veneers to the new shade."}, {"q": "Can I have veneers if I grind my teeth?", "a": "Often, yes, but grinding wears veneers faster and can chip them. We'd usually fit you with a night guard to protect them while you sleep, and talk through whether veneers are the right choice for you."}, {"q": "A veneer has chipped or come off at night. What should I do?", "a": "Keep the veneer if you can find it, and avoid biting on that tooth. If a sharp edge is catching your tongue or cheek, a small piece of sugar-free chewing gum or orthodontic wax over it will protect you for now. Don't try to glue anything back yourself, as household adhesives damage both the tooth and the veneer. Then call us, any time, day or night. We hold emergency slots every day and aim to see you quickly."}, {"q": "How do I book a consultation?", "a": "Get in touch with our Merchant City clinic and we'll find you a time that fits around your week. The first visit is a relaxed assessment where we examine your teeth, talk through what you'd like to change, and tell you whether veneers suit you before anything is decided."}],
  ...
  cta: { heading: (<>Book your<br /> <em>veneer consultation</em></>), sub: "A careful assessment of whether veneers suit your teeth, and a written plan before anything is agreed." },
}
