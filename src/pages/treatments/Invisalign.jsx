...
const data = {
  concern: {
    heading: "Crowded, crooked, or gappy teeth getting you down?",
  ...
  overviewHeading: 'Straightening without the wires',
  overview: [
  ...
  benefitsHeading: 'What’s included with every plan',
  benefits: [
  ...
  stepsHeading: 'Your Invisalign journey, step by step',
  steps: [
