...
const data = {
  ...
  lead: "Tooth-coloured resin, sculpted by hand to help with chips, gaps, worn edges and tired-looking front teeth. Often no drilling, usually done in a single visit, and largely reversible. All from our practice in the heart of Merchant City.",
  seo: { title: "Composite Bonding in Glasgow | Day Night Dental", description: "Composite bonding in Glasgow to help with chips, gaps and worn edges. Tooth-coloured, often no drilling, usually one visit, at our Merchant City practice." },
  ...
  overview: [
    (<>Composite bonding is a way of reshaping a tooth without grinding it down. Your dentist applies a soft, tooth-coloured resin, builds it up in thin layers, shapes it by hand and sets it hard with a curing light. It is the same family of material used for <Link to="/treatments/white-fillings/">white fillings</Link>, used here for looks rather than repair. The point is to smooth a chipped edge, close a small gap, lengthen a worn tooth or even out an uneven smile.</>),
    "The big draw is how little it asks of your teeth. In most cases there is little or no drilling, often no injection, and very little natural enamel is removed. Because we are adding to the tooth rather than cutting into it, bonding is usually reversible. That matters if you want to test the water before committing to anything more permanent. Most people are in and out in a single appointment, so it suits busy lives. You will find us at 80 Hutcheson Street, a couple of minutes on foot from Argyle Street and Queen Street stations and the St Enoch subway, so a visit is easy to slot into a day in central Glasgow.",
    (<>Bonding is mainly a front-teeth treatment. It works well for the teeth that show when you smile and talk. It is not built for the heavy grinding load of your back molars. It also has its weak points: composite is softer than <Link to="/treatments/porcelain-veneers/">porcelain</Link>, it can stain over time, and edges can chip. We would rather you knew all of that at the outset than felt let down later. We see patients from all over the city, and the right plan depends on your teeth, your bite and what you actually want to change.</>),
  ],
  ...
  benefits: [
    ...
    { title: 'Often no needles', body: (<>Many people have it done with no anaesthetic at all, which suits <Link to="/treatments/nervous-patients/">nervous patients</Link>.</>) },
    { title: 'One visit in most cases', body: 'Most bonding is completed in a single appointment, so you walk out with the change already made.' },
  ...
  aftercare: {
    ...
    phases: [
      ...
      { title: 'Over the years', items: ['Keep up regular check-ups and hygiene visits so we can clean, polish and catch small issues early.', 'Expect the odd re-polish or top-up to keep things looking fresh.', (<>If an edge chips, come in. We are open day and night, every day, so <Link to="/treatments/emergency-dentist/">chipped bonding can be seen and repaired</Link> whenever it happens, usually without starting over.</>)] },
    ],
  },
  risks: {
    eyebrow: 'Before you decide',
    heading: (<>Know the <em>limits</em> before you start</>),
    body: [
      "It does not last forever. Composite is softer than porcelain. With good care many people get around three to five years out of it, often longer, but it is a maintenance treatment rather than a one-off fix.",
  ...
  fees: {
    ...
    body: [
      ...
      "Edge bonding on one or two teeth is a smaller job than full composite veneers across your smile, and the quote reflects that.",
  ...
  faqs: [{"q": "Does composite bonding hurt? Will I need an injection or drilling?", "a": "For most people it is painless and needs no injection, because we are adding to the tooth rather than drilling into it. Occasionally a small amount of shaping is needed, and we will talk you through it first. It is a comfortable treatment for nervous patients."}, {"q": "How long does composite bonding last?", "a": "There is no fixed number, but as a rough guide many people get around three to five years from it, often longer with good care, sometimes with small repairs along the way. How long depends on your habits: grinding, nail-biting, smoking and lots of staining drinks all shorten its life. Regular check-ups and the odd polish help it last."}, {"q": "How much does composite bonding cost?", "a": "Every mouth is different, so the honest answer is that it depends on you: how many teeth you are treating, whether you need light edge bonding or fuller coverage, and whether whitening comes first so the resin can be matched to your final shade. At your consultation the dentist will go through your options and the cost of each, and you will get a written, itemised quote before anything is agreed. Nothing goes ahead until you are happy."}, {"q": "Can I get composite bonding on the NHS?", "a": "Purely cosmetic treatment, which includes bonding, veneers, whitening and smile makeovers, is private-only, so bonding done to change how healthy teeth look is not available through the NHS. Repairing a tooth because of decay or damage is a different, clinical matter. For wider context: NHS dental examinations are free for everyone in Scotland. NHS dental treatment is free if you are under 26, pregnant or have given birth in the last 12 months, or qualify for a low-income exemption."}, {"q": "Is composite bonding reversible?", "a": "Largely, yes. Because little or no natural enamel is removed, your dentist can usually take the resin off and return close to your starting point. That is one of its main advantages over veneers and crowns."}, {"q": "Should my teeth be whitened before bonding?", "a": "If you want whiter teeth overall, your dentist will usually whiten them first. The resin is matched to your tooth colour at the time of treatment and will not lighten with whitening afterwards. So whitening comes first, the shade is left to settle, then the bonding is matched to it."}, {"q": "Can composite bonding close gaps between my teeth?", "a": "It can close small gaps well, usually gaps of a few millimetres. Larger gaps, or gaps caused by the way your teeth are positioned, may be better closed with aligners first. We will measure and tell you plainly which suits you."}, {"q": "Can it help with crooked teeth, or do I need braces or aligners first?", "a": "Bonding can mask small irregularities. If your teeth are noticeably crooked, straightening them first with aligners or braces usually gives a better, longer-lasting result than trying to disguise the problem with resin. We are happy to map out both options."}, {"q": "Does composite bonding stain, and can it be whitened later?", "a": "It can stain over time, more so than porcelain, especially with coffee, tea, red wine and smoking. The resin cannot be whitened once it is set. Good cleaning, a sensible approach to staining drinks and the occasional professional polish keep it looking its best."}, {"q": "How many teeth should I have bonded?", "a": "There is no set number. Some people need a single chipped edge evened up, while others treat the four to ten teeth that show when they smile for a balanced result. We agree the number with you at the consultation, and we will not push you to treat more teeth than your smile actually needs."}, {"q": "Can I eat and drink straight after composite bonding?", "a": "Yes. The resin is fully set by the curing light before you leave, so there is no waiting around. We simply suggest going easy on staining food and drink, especially coffee, tea, red wine and curry, for the first 48 hours. Some people notice mild sensitivity for a day or so afterwards, but most feel nothing at all."}, {"q": "Can composite bonding be done on my back teeth?", "a": "It is really a front-teeth treatment. Back teeth take heavy chewing forces that bonding is not built for, so it tends not to last there. For back teeth we would look at sturdier options."}, {"q": "What is the difference between edge bonding and full composite bonding?", "a": "Edge bonding is the lighter touch. We add a little resin to the biting edges of the front teeth to smooth a chip, even up a worn or jagged edge, or add a touch of length. Full composite bonding, sometimes called composite veneers, covers more of the visible face of the tooth to change colour, shape and width more noticeably. It takes longer per tooth and gives a bigger change. Many people only need edge bonding once they see what it can do."}, {"q": "I have chipped a tooth or my bonding out of hours. What should I do?", "a": "Keep any broken piece if you can find it, rinse your mouth gently with warm water, and cover a sharp edge with sugar-free chewing gum or dental wax if it is catching your tongue or cheek. Avoid biting on that tooth. Then call us. We are open day and night, every day, we hold same-day emergency slots and we aim to see you quickly, so a chip does not have to wait until Monday."}],
  ...
  cta: { heading: (<>Book your<br /> <em>composite bonding consultation</em></>), sub: "A clear look at whether bonding suits your teeth, at a time that fits around your life." },
}
